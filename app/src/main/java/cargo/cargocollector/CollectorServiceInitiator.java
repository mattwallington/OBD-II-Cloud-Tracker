 ...
 */
public class CollectorServiceInitiator {
    ...
    public CollectorServiceInitiator(Context context, MainActivity activity) {
        m_context = context;
        m_activity = activity;
    }

    public CollectorServiceInitiator(Context context) {
        m_context = context;
    }
